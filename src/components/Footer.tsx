          ...
          <div className="flex flex-wrap justify-center gap-6">
            {footerLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="text-sm theme-text-secondary hover:text-primary-400 transition-colors"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="text-center md:text-right space-y-3">
            <div className="flex justify-center md:justify-end gap-3">
              <a
                ...
                className="w-9 h-9 rounded-lg glass flex items-center justify-center theme-text-secondary hover:text-blue-400 transition-colors"
                title="LinkedIn"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg glass flex items-center justify-center theme-text-secondary hover:text-primary-400 transition-colors"
                title="GitHub"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg glass flex items-center justify-center theme-text-secondary hover:text-green-400 transition-colors"
                title="WhatsApp"
              >
